...
def task_specifier_prompts(assistant_role_name: str, user_role_name: str, task: str):
    ...
    return task_specifier_sys_msg, task_specifier_msg

def get_specified_task(task_specifier_sys_msg, task_specifier_msg):
    task_specify_agent = CAMELAgent(system_message=task_specifier_sys_msg, model=ChatOpenAI(model="gpt-3.5-turbo-1106", temperature=0.0))
    specified_task_msg = task_specify_agent.step(task_specifier_msg)
    specified_task = specified_task_msg.content
    return specified_task

def inception_prompts(assistant_role_name: str, user_role_name: str, task: str):
    ...
    return assistant_inception_prompt, user_inception_prompt
